...
set_lnmp_checker_redis() {
    ...
    if [ -f /etc/centos-release ]; then
        ...
        chkconfig --add lnmp_checker_redis
        chkconfig lnmp_checker_redis on
